...
Game.PickClass.prototype = {
	create: function () {
        ...
        var builder = this.add.sprite(50, 25, 'class_builder');
        var ninja = this.add.sprite(425, 25, 'class_ninja');
        var merchant = this.add.sprite(50, 275, 'class_merchant');
        var tank = this.add.sprite(425, 275, 'class_tank');
